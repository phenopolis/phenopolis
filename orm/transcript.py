...
class Transcript(object):
    ...
    def __init__(self, transcript_id, db=None):
        ...
        Transcript.db=db
        self.data=Transcript.db.transcripts.find_one({'transcript_id':self.transcript_id},projection={'_id':False})
    ...
    def get_variants_in_transcript(self):
        ...
        variants = []
        print('transcripts')
        for variant in Transcript.db.variants.find({'transcripts': self.transcript_id}, projection={'_id': False}):
