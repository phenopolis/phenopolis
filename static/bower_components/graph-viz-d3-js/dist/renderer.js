...
define('stage',["d3", "palette", "transitions/default"], function (d3, palette, defaults) {
    ...
    function calculateSizes(main) {
      var margin = 4,
        ...
        vtranslate = margin,
        size = [$(this_id).width(), $(this_id).height()] || [boundingWidth, boundingHeight];
  ...
  return {
    ...
    render: function(obj) {
      ...
      if (typeof(obj) == 'object'){
      	myS = obj.source, myC = obj.callBack, myA = obj.labelAttributer, myR = obj.raw;
      } else {
      	myS = obj;
      }
      if (initialized) {
